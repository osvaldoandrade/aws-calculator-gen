...
const (
	// CreateEstimateXPath locates the initial "Create estimate" button on
	// the AWS pricing calculator landing page.
	CreateEstimateXPath = "//button[contains(., 'Create estimate') or .//span[contains(., 'Create estimate')]]"
