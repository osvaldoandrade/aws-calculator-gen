...
// IncentiveCommand implements incentive helpers.
type IncentiveCommand struct{}

// Name returns command name.
func (IncentiveCommand) Name() string { return "incentive" }

// Command builds the incentive root command with MAP helpers.
func (IncentiveCommand) Command() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "incentive",
		Short: "incentive utilities",
		Long:  "Work with AWS incentive artifacts like MAP.",
	}
